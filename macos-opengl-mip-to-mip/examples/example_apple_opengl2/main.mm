...
-(void)initialize
{
                                                      ...
                                                      void main() {
                                                          fragColor = texelFetch(
                                                            tex, ivec3(
                                                               0,
                                                               0,
                                                               int(gl_FragCoord.x) / 32 % 2),
                                                               int(gl_FragCoord.y) / 32 % 2);
                                                      })"));
  ...
  glAttachShader(program2,
                 compileShader(GL_FRAGMENT_SHADER, R"(#version 410
                                                    ...
                                                    out vec4 fragColor;
                                                    void main() {
                                                        fragColor = texelFetch(tex, ivec3(0, 0, 0), 0).bgra;
                                                    })"));
  ...
  uint8_t colorMip1[] = {
    ...
    glTexImage3D(GL_TEXTURE_2D_ARRAY, 0, GL_RGBA, 2, 2, 2, 0, GL_RGBA, GL_UNSIGNED_BYTE, &colorMip0);
    glTexImage3D(GL_TEXTURE_2D_ARRAY, 1, GL_RGBA, 1, 1, 2, 0, GL_RGBA, GL_UNSIGNED_BYTE, &colorMip1);
